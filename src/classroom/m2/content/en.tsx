...
export const en: M2Strings = {
  ...
  guide: {
    ...
    accessibility: [
      ...
      "Reduced motion: with prefers-reduced-motion (or in a background tab) the hundred rolls land at once instead of over 0.7 s. Phase 4 (2026-08-23): the page passes an automated WCAG 2.1 AA audit (axe-core, zero violations in both languages) and a keyboard walk; every text field and slider is named, the Gamble's bars are a named list, each word the Loop writes is a button (Enter opens the alternatives, Escape closes them) with a “Show the step log” table beneath, the Loop's run lands at once under reduced motion, and a skip link opens every page. Still open: no text-to-speech of prompts, and no testing with a real screen reader yet. The conformance statement, with the full known-gaps table, is the Accessibility statement page (#/classroom/about/accessibility).",
    ],
    embed: {
      slides: () => (
        <>
