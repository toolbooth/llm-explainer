...
*Inside the Machine: Classroom Edition · shared front matter · draft 2026-08-22; revised 2026-09-16 against PRODUCT.md r2 — the EO 14277 Sec. 6 wording caveat resolved, ED supplemental priorities (a)(ii), (a)(ix) and (a)(x) added.*
...
- **Sec. 6** — directs agencies to establish "public-private partnerships with leading AI industry organizations, academic institutions, nonprofit entities, and other organizations with expertise in AI and computer science education to collaboratively develop online resources focused on teaching K–12 students foundational AI literacy and critical thinking skills." *(Brief, Aug 2026. The earlier draft's wording caveat is resolved by PRODUCT.md r2: the short "online resources …" fragment is verbatim, but it is a clause inside this partnership directive — quote it with that context. Sec. 6 tasks federal agencies and their partners with producing such resources; it does not endorse or certify third-party ones.)*
- **Sec. 7** — "professional development for all educators, so they can integrate the fundamentals of AI into all subject areas." *(Brief, Aug 2026; confirmed verbatim by PRODUCT.md r2 — a fragment of the directive on discretionary teacher-training grants.)*
...
Source: govinfo.gov/content/pkg/FR-2026-04-13/pdf/2026-07087.pdf. *(All quotations: Brief, Aug 2026, except priorities (a)(ii), (a)(ix) and (a)(x), which PRODUCT.md §2.1 r2 added from the same Federal Register text — not separately re-verified by this page.)*
...
- **Priority (a)(ii)** — "Expand offerings of age-appropriate AI and computer science education in K–12 education." *Alignment:* each module is one to three class periods of free AI instruction for grades 9 and up, sized to drop into an existing CS course — the material a district expanding its offerings under an Alabama-, Georgia- or Mississippi-style requirement needs on day one.
- **Priority (a)(ix)** — "Support dissemination of appropriate methods of integrating AI into education." *Alignment:* the lessons, teacher guides, printables and embed kit are open source, free and redistributable, so anyone whose funded work is dissemination can carry them without asking us.
- **Priority (a)(x)** — "Build evidence of appropriate methods of integrating AI into education." *Alignment:* the "I taught with this" page collects voluntary, teacher-level use reports — evidence in ED's own sense — without ever collecting student data.
