...
- **Engine license.** nano-lm's license "will be chosen before the open-source release" and is subject to the author's employer open-source approval gate [nano-lm README "Status"; PRODUCT.md §9 row 5]. Placeholder: `[LICENSE — TBD after OSS approval]`.
